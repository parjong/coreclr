...
// by anyone.
    ...
    JITHELPER(CORINFO_HELP_TRAP, JIT_TrapHelper, CORINFO_HELP_SIG_REG_ONLY)
    JITHELPER(CORINFO_HELP_LOGGING_METHOD, JIT_MethodLoggingHelper, CORINFO_HELP_SIG_REG_ONLY)
