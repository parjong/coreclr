...
CONFIG_STRING_INFO_EX(INTERNAL_JitLogMethod, W("JitLogMethod"), "Emits CORINFO_HELP_METHOD_LOGGING call into the beginning of each jitted method", CLRConfig::REGUTIL_default)
