...
CONFIG_METHODSET(JitTrap, W("JitTrap")) // Emits break instruction into jitted code
CONFIG_METHODSET(JitLogMethod, W("JitLogMethod")) // Emits break instruction into jitted code
